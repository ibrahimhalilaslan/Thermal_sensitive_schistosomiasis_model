#This script perform multiple different thermal sensitive models to find the best fit for cercariae death rate 
...
# plot
pdf(file = "multip_mort_rate_cer.pdf")
