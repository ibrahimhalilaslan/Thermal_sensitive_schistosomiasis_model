...
#w_pfluger_81_s_mansoni_with_biomphalaria_glabrata 
...
#w_pfluger_80_s_mansoni_with_biomphalaria_glabrata 
...
#Foster_64_Biomphalaria_pfeifleri_with_s. mansoni 
...
ggplot(d, aes(temp, rate)) +
  ...
  labs(x = 'Temperature (ºC)',
       y = 'Transition rate to infected class',
       title = 'Transition rate from latent to infected compartment across temperatures')
...
# plot
pdf(file = "multip_laten_rate_snail.pdf", width = 5, height = 5)
ggplot(d_preds, aes(temp, rate)) +
  ...
  labs(temp = 'Temperature (ºC)',
       rate = 'Transition rate from exposed class to infected class',
