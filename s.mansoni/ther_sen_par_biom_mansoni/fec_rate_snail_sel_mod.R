...
plot(preds$temp, preds$.fitted, col = 1,  pch = 21, lwd = 3, ylab = "",  xlab = "", cex.lab = 1.3, type = "l",  cex.axis=1.3,
     xlim = c(min(preds$temp), max(preds$temp)), ylim = c(0, 0.09))
...
points(temp_sturr_72, rate_sturr_72, col = 5, pch = 19)
points(temp_mccreesh_14, rate_mccreesh_14, col = 6, pch = 19)
points(temp_michel_61, rate_michel_61, col = 7, pch = 19)
points(temp_shiff_63, rate_shiff_63, col = 8, pch = 19)
...
legend("bottomleft", inset=c(0, 1.01), legend=c(expression(paste(italic('B. pfeifferi,'), "  C. C. APPLETON, 1977")),
                                              ...
                                              expression(paste(italic('B. glabrata,'), "  R. F. Sturrock and B. M. Sturrock, 1972")),
...
mtext(text = "Fecundity rate of snails per day", side = 2, line = 2.5, cex = 2)
...
plot(preds$temp, preds$.fitted, col = 1,  pch = 21, lwd = 3, ylab = "",  xlab = "", cex.lab = 2, type = "l",  cex.axis=2,
     xlim = c(min(preds$temp), max(preds$temp)), ylim = c(0, 0.09), las =1)
...
mtext(text = expression(nu[s]), side = 2, line = 5, cex = 2.5, las = 1)
