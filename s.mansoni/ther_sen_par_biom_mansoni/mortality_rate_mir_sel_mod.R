...
plot(preds$temp, preds$.fitted, col = 1,  pch = 21, lwd = 3, las = 1, ylab = "",  xlab = "", cex.lab = 1.3, type = "l",
...
mtext(text = expression(mu[m]), side = 2, line = 5, cex = 2, las = 1)
...
plot(preds$temp, preds$.fitted, col = 1,  pch = 21, lwd = 3, las = 1, ylab = "",  xlab = "", cex.lab = 2, type = "l", cex.axis=2,
     xlim = c(min(c(preds$temp, d$temp)), max(c(preds$temp, d$temp))), ylim = c(min(c(preds$.fitted, d$rate)), max(c(preds$.fitted, d$rate))))
...
mtext(text = expression(paste("Temperature (",degree,"C)")), side = 1, line = 4, cex = 2)
mtext(text = expression(mu[m]), side = 2, line = 2.5, cex = 2.5, las = 1)
mtext(text = expression(paste(italic('S. mansoni'))), side = 3, line = 2, cex = 2)
