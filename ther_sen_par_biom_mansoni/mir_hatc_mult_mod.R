...
ggplot(d, aes(temp, rate)) +
  ...
  labs(x = 'Temperature (ºC)',
       y = 'Propotion of miracidia successfully hatch',
       title = 'Miracidia hatching sucesses')
...
# plot
pdf(file = "mult_mir_hatch_rate.pdf")
ggplot(d_preds, aes(temp, rate)) +
  ...
  labs(temp = 'Temperature (ºC)',
       rate = 'Probability of miracidia hatch',
...
print(n = length(d_ic$AIC), d_ic[order(d_ic$AIC),])